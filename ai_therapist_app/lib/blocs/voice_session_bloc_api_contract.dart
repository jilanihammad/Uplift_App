...
abstract class VoiceSessionStateContract {
  ...
  bool
      get isListeningForVoice; // => isVADActive && !isRecording && !isProcessing && !isAiSpeaking
...
abstract class VoiceSessionStreamContract {
  ...
  /// Thread: Main thread only
  static const String audioPlaybackStream =
      'audioPlayerManager.isPlayingStream';
...
abstract class VoiceSessionBehaviorContract {
  ...
  static const String messageSequencingBehavior =
      'incremental-message-sequence';
...
abstract class VoiceSessionTestContract {
  ...
  static const String characterizationTests =
      'test/blocs/voice_session_bloc_characterization_test.dart';
}
