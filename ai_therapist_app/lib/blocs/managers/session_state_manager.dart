...
class SessionStateManager {
  ...
  VoiceSessionState initializeSession({
    ...
    if (kDebugMode) {
      debugPrint(
          '[SessionStateManager] Initializing session with ID: $sessionId');
    }
  ...
  VoiceSessionState startNewSession() {
    if (kDebugMode) {
      debugPrint(
          '[SessionStateManager] Starting new session - resetting state');
    }
  ...
  VoiceSessionState selectDuration(Duration duration) {
    if (kDebugMode) {
      debugPrint(
          '[SessionStateManager] Duration selected: ${duration.inMinutes} minutes');
    }
