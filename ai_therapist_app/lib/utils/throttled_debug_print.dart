...
class ThrottledDebugPrint {
  ...
  static const Duration _throttleInterval = Duration(milliseconds: 500); // 500ms throttle
  ...
  static void debugPrintThrottledWithCounter(String baseMessage, {String? key}) {
    if (!kDebugMode) return;
    ...
    final message = counter > 0 ? '$baseMessage (skipped $counter similar)' : baseMessage;
