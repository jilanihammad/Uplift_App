...
class AudioVisualizerWidget extends StatefulWidget {
  ...
  final bool motionSensitive;       // Accessibility: disable for motion-sensitive users
...
class _RipplePainter extends CustomPainter {
  ...
  void _paintBreathingRipple(Canvas canvas, Offset center, double maxRadius, Paint paint) {
  ...
  void _paintAmplitudeRipple(Canvas canvas, Offset center, double maxRadius, Paint paint) {
    if (amplitude < 0.01) {
    ...
    for (int i = 0; i < numRipples; i++) {
      ...
      final opacity = AmplitudeUtils.amplitudeToOpacity(amplitude) * (1.0 - progress * 0.7);
  ...
  void _paintProcessingRipple(Canvas canvas, Offset center, double maxRadius, Paint paint) {
  ...
  void _paintSpeakingRipple(Canvas canvas, Offset center, double maxRadius, Paint paint) {
...
class _BarsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < barCount; i++) {
      ...
      final color = (state == VisualizationState.speaking) ? accentColor : primaryColor;
