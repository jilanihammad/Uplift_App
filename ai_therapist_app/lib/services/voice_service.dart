...
class VoiceService {
  ...
  Future<void> enableAutoModeWhenPlaybackCompletes() async {
    if (_disposed) {
      return;
    }

    if (kDebugMode) {
      debugPrint('[VoiceService] enableAutoModeWhenPlaybackCompletes called');
    }
    ...
    if (_ttsActive) {
      try {
        ...
        if (kDebugMode) {
          debugPrint(
              '[VoiceService] Waiting for TTS to finish timed out: $e (continuing)');
        }
      }
    }
