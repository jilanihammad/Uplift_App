...
class TherapyEdge {
  ...
  bool isConditionMet(Map<String, dynamic> state) {
    ...
    } else if (condition == 'has_goal' && state['has_therapeutic_goal'] != null) {
...
class TherapyGraphService {
  ...
  void _initializeTherapyGraph() {
    ...
    _addNode(
      ...
      metadata: {
        'prompt_template': 'Welcome to our therapy session. To help me understand how best to support you today, could you share what brings you here and how you\'ve been feeling lately?',
    ...
    _addNode(
      ...
      metadata: {
        'prompt_template': 'I\'d like to understand more about how you\'re feeling. Can you tell me more about these emotions and when you typically experience them?',
    ...
    _addNode(
      ...
      metadata: {
        'prompt_template': 'It sounds like you\'re experiencing {emotion}. What thoughts or beliefs might be connected to this feeling?',
    ...
    _addNode(
      ...
      metadata: {
        'prompt_template': "Let's look more closely at the thought \"{identified_thought}\". What evidence supports this thought? Is there any evidence that doesn't support it?",
    ...
    _addNode(
      ...
      metadata: {
        'prompt_template': "I'd like to understand what truly matters to you. What are some values or principles that guide your life?",
    ...
    _addNode(
      ...
      metadata: {
        'prompt_template': "Based on what we've discussed, let's identify a specific action you can take this week that aligns with your values.",
    ...
    _addNode(
      ...
      metadata: {
        'prompt_template': "Let's talk about strategies you can use when experiencing {emotion}. Have you tried any techniques that have worked for you before?",
    ...
    _addNode(
      ...
      metadata: {
        'prompt_template': "I'm hearing that you're experiencing significant distress right now. Your safety is the priority. Let's focus on helping you through this immediate moment.",
    ...
    _addNode(
      ...
      metadata: {
        'prompt_template': "Let's summarize the key insights and the specific steps you've committed to. How are you feeling about these next steps?",
    ...
    _addEdge(sourceId: 'intake', targetId: 'crisis_support', condition: 'has_distress');
    _addEdge(sourceId: 'intake', targetId: 'values_exploration');
    
    // Emotional exploration paths
    _addEdge(sourceId: 'emotion_exploration', targetId: 'thought_identification');
    _addEdge(sourceId: 'emotion_exploration', targetId: 'coping_skills');
    _addEdge(sourceId: 'emotion_exploration', targetId: 'crisis_support', condition: 'has_distress');
    
    // Thought work paths
    _addEdge(sourceId: 'thought_identification', targetId: 'thought_challenging');
    ...
    _addEdge(sourceId: 'values_exploration', targetId: 'thought_identification');
...
[THERAPEUTIC GUIDANCE: Help create SMART goals (Specific, Measurable, Achievable, Relevant, Time-bound) that align with their values.]""");
  ...
  TherapyNode? moveToNextNode() {
    ...
    final availableEdges = _edges.where((edge) => 
  ...
  Map<String, double> _calculateNodeRelevance(List<TherapyEdge> edges) {
    ...
    for (final edge in edges) {
      ...
      if (targetNode != null) {
        ...
        if ((targetNode.id == 'thought_identification' || targetNode.id == 'thought_challenging') &&
  ...
  String _weightedRandomSelection(Map<String, double> nodeWeights) {
    double totalWeight = nodeWeights.values.fold(0.0, (sum, weight) => sum + weight);
