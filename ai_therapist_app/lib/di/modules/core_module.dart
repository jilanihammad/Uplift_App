...
class _MockApiClient implements IApiClient {
  ...
  @override
  Future<Map<String, dynamic>> uploadFile(String endpoint, String fieldName, List<int> fileData, String fileName, {Map<String, String>? headers, Map<String, String>? additionalFields}) async {
...
class _MockDatabase implements IDatabase {
  ...
  @override
  Future<List<Map<String, dynamic>>> query(String table, {List<String>? columns, String? where, List<dynamic>? whereArgs, String? orderBy, int? limit, int? offset}) async {
    return [];
  }
...
class _ConfigServiceAdapter implements IConfigService {
  ...
  @override
  String get environment => _configService.isProductionMode ? 'production' : 'development';
  ...
  @override
  String get websocketUrl => _configService.llmApiEndpoint.replaceFirst('http', 'ws');
  ...
  @override
  bool get enableVoiceRecording => true; // Default values for features not in ConfigService
...
class _DatabaseAdapter implements IDatabase {
  ...
  Future<List<Map<String, dynamic>>> query(String table, {List<String>? columns, String? where, List<dynamic>? whereArgs, String? orderBy, int? limit, int? offset}) async {
    final db = await _database.database;
    return await db.query(table, columns: columns, where: where, whereArgs: whereArgs, orderBy: orderBy, limit: limit, offset: offset);
  }
