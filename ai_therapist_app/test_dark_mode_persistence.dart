...
void main() {
  group('Dark Mode Persistence Tests', () {
    test('ThemeService should load saved dark mode preference on init',
        () async {
      // Setup
    ...
    test('ThemeService should default to light mode when no preference exists',
        () async {
      // Setup
    ...
    test('ThemeService should persist dark mode preference when toggled',
        () async {
      // Setup
      SharedPreferences.setMockInitialValues({});
