...
void main() {
  ...
  group('Text Session Integration Tests', () {
    testWidgets('Complete text therapy session end-to-end',
    ...
    testWidgets('Text session with rapid message sending',
        (WidgetTester tester) async {
      ...
      final rapidMessages = ['Hello', 'How are you?', 'I\'m doing well today'];
    ...
    testWidgets('Empty message handling in text mode',
        (WidgetTester tester) async {
      // Setup session
      app.main();
      await tester.pumpAndSettle();
