...
void main() {
  ...
  group('Voice Session Integration Tests', () {
    testWidgets('Complete voice therapy session end-to-end', (WidgetTester tester) async {
      // Start app
      app.main();
    ...
    testWidgets('Voice session interruption and recovery', (WidgetTester tester) async {
