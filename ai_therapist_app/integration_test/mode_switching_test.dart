...
void main() {
  ...
  group('Mode Switching Integration Tests', () {
    testWidgets('Seamless voice ↔ text mode switching during session', (WidgetTester tester) async {
      ...
      // Send a text message
      await tester.enterText(find.byType(TextField), 'I feel anxious about my presentation tomorrow.');
      ...
      expect(find.text('I feel anxious about my presentation tomorrow.'), findsOneWidget);
    ...
    testWidgets('Rapid mode switching stress test', (WidgetTester tester) async {
      // Setup session
      app.main();
      await tester.pumpAndSettle();
      ...
      await tester.tap(find.byIcon(Icons.chat));
      await tester.pumpAndSettle();
      await tester.enterText(find.byType(TextField), 'System still working after rapid switching');
      await tester.tap(find.byIcon(Icons.send));
      await tester.pumpAndSettle();
      ...
      expect(find.text('System still working after rapid switching'), findsOneWidget);
    ...
    testWidgets('Mode switching with active audio playback', (WidgetTester tester) async {
      // Setup session
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Mode switching preserves conversation state', (WidgetTester tester) async {
      // Setup session
      app.main();
      await tester.pumpAndSettle();
      ...
      // Send first message
      await tester.enterText(find.byType(TextField), 'First message in text mode');
      await tester.tap(find.byIcon(Icons.send));
      await tester.pumpAndSettle();
      await tester.pumpAndSettle(const Duration(seconds: 5));
      ...
      // Send second message
      await tester.enterText(find.byType(TextField), 'Second message after mode switching');
      await tester.tap(find.byIcon(Icons.send));
      await tester.pumpAndSettle();
      await tester.pumpAndSettle(const Duration(seconds: 5));
