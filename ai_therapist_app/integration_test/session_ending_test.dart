  ...
  group('Session Ending and Navigation Tests', () {
    testWidgets('Normal session ending flow', (WidgetTester tester) async {
      ...
      await tester.enterText(
          find.byType(TextField), 'I had a wonderful day today!');
      ...
      expect(find.text('Are you sure you want to end this session?'),
          findsOneWidget);
    ...
    testWidgets('Cancel session ending', (WidgetTester tester) async {
      ...
      await tester.enterText(
          find.byType(TextField), 'Just testing the cancel flow');
      await tester.tap(find.byIcon(Icons.send));
      await tester.pumpAndSettle();
      ...
      await tester.enterText(
          find.byType(TextField), 'Session continued after cancel');
      await tester.tap(find.byIcon(Icons.send));
      await tester.pumpAndSettle();
    ...
    testWidgets('Back button prevention during active session',
      ...
      await tester.enterText(
          find.byType(TextField), 'Testing back button prevention');
      await tester.tap(find.byIcon(Icons.send));
      await tester.pumpAndSettle();
      await tester.pumpAndSettle(const Duration(seconds: 5));
      ...
      if (backButton.evaluate().isNotEmpty) {
        ...
        expect(find.text('Please use the End button to finish your session.'),
            findsOneWidget);
    ...
    testWidgets('Session ending with network error recovery',
        (WidgetTester tester) async {
      // Setup session
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Empty session ending (no messages)',
        (WidgetTester tester) async {
